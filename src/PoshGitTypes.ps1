...
class PoshGitPromptSettings {
    ...
    [PoshGitCellColor]$WorkingColor = [PoshGitCellColor]::new([ConsoleColor]::Magenta)
    ...
    [PoshGitTextSpan]$LocalWorkingStatusSymbol = [PoshGitTextSpan]::new('!', [ConsoleColor]::Magenta)
